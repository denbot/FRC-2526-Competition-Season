...
public enum onTheFlyOffsets {
    ...
    NEUTRAL_EDGE_MID_FROM_LEFT(2.5, 0.5, -90),
    NEUTRAL_EDGE_MID_FROM_RIGHT(2.5, -0.5, 90),
    NEUTRAL_EDGE_LEFT(2.5, 2.75, -90),
    NEUTRAL_EDGE_RIGHT(2.5, -2.75, 90),
    NEUTRAL_CENTER_MID_FROM_LEFT(3, 0.5, -90),
    NEUTRAL_CENTER_MID_FROM_RIGHT(3, -0.5, 90),
    ...
    SCORE_LEFT(1.3, -1.3, 150),
    SCORE_RIGHT(1.3, 1.3, -150),
