...
public enum onTheFlySetpoints {
    ...
    // Ramp Locations
    RAMP_LEFT_NEUTRAL(6, 22, onTheFlyOffsets.RAMP_OFFSET_POSITIVE_NEUTRAL),
    RAMP_LEFT_ALLIANCE(7, 23, onTheFlyOffsets.RAMP_OFFSET_NEGATIVE_ALLIANCE),
    RAMP_RIGHT_NEUTRAL(1, 17, onTheFlyOffsets.RAMP_OFFSET_NEGATIVE_NEUTRAL),
    RAMP_RIGHT_ALLIANCE(12, 28, onTheFlyOffsets.RAMP_OFFSET_POSITIVE_ALLIANCE),
