...
public enum onTheFlySetpoints {
    ...
    // Trench Locations
    TRENCH_LEFT_FAR(6, 28, onTheFlyOffsets.TRENCH_FAR),
    TRENCH_LEFT_CLOSE(7, 17, onTheFlyOffsets.TRENCH_CLOSE),
    TRENCH_RIGHT_FAR(1, 23, onTheFlyOffsets.TRENCH_FAR),
    TRENCH_RIGHT_CLOSE(12, 22, onTheFlyOffsets.TRENCH_CLOSE),
    // Ramp Locations
    RAMP_LEFT_FAR(5, 22, onTheFlyOffsets.RAMP_FAR),
    RAMP_LEFT_CLOSE(8, 23, onTheFlyOffsets.RAMP_CLOSE),
    RAMP_RIGHT_FAR(2, 17, onTheFlyOffsets.RAMP_FAR),
    RAMP_RIGHT_CLOSE(12, 28, onTheFlyOffsets.RAMP_CLOSE),
    // Neutral Zone Locations
    // Closest April Tag Alignment handles Y offset, only X offset is required
    NEUTRAL_CLOSE_TOP(6, 17, onTheFlyOffsets.NEUTRAL_CLOSE),
    NEUTRAL_CLOSE_MID(4, 20, onTheFlyOffsets.NEUTRAL_CLOSE),
    NEUTRAL_CLOSE_BOTTOM(1, 22, onTheFlyOffsets.NEUTRAL_CLOSE),
    ...
    NEUTRAL_FAR_TOP(17, 6, onTheFlyOffsets.NEUTRAL_FAR),
    NEUTRAL_FAR_MID(20, 4, onTheFlyOffsets.NEUTRAL_FAR),
    NEUTRAL_FAR_BOTTOM(22, 1, onTheFlyOffsets.NEUTRAL_FAR),
    // Climb Locations
    ...
    SCORE_LEFT(8, 24, onTheFlyOffsets.SCORE_LEFT),
    SCORE_CENTER(9, 25, onTheFlyOffsets.SCORE_CENTER),
    SCORE_RIGHT(11, 27, onTheFlyOffsets.SCORE_RIGHT);
