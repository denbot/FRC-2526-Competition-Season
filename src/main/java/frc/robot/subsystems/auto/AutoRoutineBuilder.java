...
public class AutoRoutineBuilder {
    ...
    public void addSweep(autoOptions startSide, autoOptions sweepAlignment){
        ...
        addAction(SequentialPathGenerator.getSequentialPath(
            isBlue,
            new double[]{4.0, 1.0},
            startSide==autoOptions.BORDER_LEFT
                ?sweepAlignment==autoOptions.SWEEP_EDGE?onTheFlySetpoints.NEUTRAL_EDGE_LEFT:onTheFlySetpoints.NEUTRAL_CENTER_LEFT
                :sweepAlignment==autoOptions.SWEEP_EDGE?onTheFlySetpoints.NEUTRAL_EDGE_RIGHT:onTheFlySetpoints.NEUTRAL_CENTER_RIGHT,
            startSide==autoOptions.BORDER_LEFT
                ?sweepAlignment==autoOptions.SWEEP_EDGE?onTheFlySetpoints.NEUTRAL_EDGE_MID_FROM_LEFT:onTheFlySetpoints.NEUTRAL_CENTER_MID_FROM_LEFT
                :sweepAlignment==autoOptions.SWEEP_EDGE?onTheFlySetpoints.NEUTRAL_EDGE_MID_FROM_RIGHT:onTheFlySetpoints.NEUTRAL_CENTER_MID_FROM_RIGHT)
        .raceWith(
            this.intake.setIntakeMaxLength()
            .alongWith(this.intake.runIntake(RotationsPerSecond.of(80)))
            .alongWith(this.indexer.runIndexer()))
            ,"Sweep "+(sweepAlignment==autoOptions.SWEEP_EDGE?"Edge ":"Center ") +(startSide==autoOptions.BORDER_LEFT?"Left":"Right"));
        ...
        addAction(SequentialPathGenerator.getSequentialPath(
            ...
            new onTheFlySetpoints[]{
            startSide==autoOptions.BORDER_LEFT
                ?sweepAlignment==autoOptions.SWEEP_EDGE?onTheFlySetpoints.NEUTRAL_EDGE_MID_FROM_RIGHT:onTheFlySetpoints.NEUTRAL_CENTER_MID_FROM_RIGHT
                :sweepAlignment==autoOptions.SWEEP_EDGE?onTheFlySetpoints.NEUTRAL_EDGE_MID_FROM_LEFT:onTheFlySetpoints.NEUTRAL_CENTER_MID_FROM_LEFT,
            startSide==autoOptions.BORDER_LEFT
                ?sweepAlignment==autoOptions.SWEEP_EDGE?onTheFlySetpoints.NEUTRAL_CENTER_MID_FROM_LEFT:onTheFlySetpoints.NEUTRAL_EDGE_MID_FROM_LEFT
                :sweepAlignment==autoOptions.SWEEP_EDGE?onTheFlySetpoints.NEUTRAL_CENTER_MID_FROM_RIGHT:onTheFlySetpoints.NEUTRAL_EDGE_MID_FROM_RIGHT,
            startSide==autoOptions.BORDER_LEFT
                ?sweepAlignment==autoOptions.SWEEP_EDGE?onTheFlySetpoints.NEUTRAL_CENTER_LEFT:onTheFlySetpoints.NEUTRAL_EDGE_LEFT
                :sweepAlignment==autoOptions.SWEEP_EDGE?onTheFlySetpoints.NEUTRAL_CENTER_RIGHT:onTheFlySetpoints.NEUTRAL_EDGE_RIGHT},
            new Double[]{
                (isBlue?(startSide==autoOptions.BORDER_LEFT?-90.0:90.0):(startSide==autoOptions.BORDER_RIGHT?90.0:-90.0)),
                (isBlue?(startSide==autoOptions.BORDER_LEFT?90.0:-90.0):(startSide==autoOptions.BORDER_RIGHT?-90.0:90.0)),
                (isBlue?(startSide==autoOptions.BORDER_LEFT?90.0:-90.0):(startSide==autoOptions.BORDER_RIGHT?-90.0:90.0))})
        .raceWith(
            this.intake.setIntakeMaxLength()
            .alongWith(this.intake.runIntake(RotationsPerSecond.of(80)))
            .alongWith(this.indexer.runIndexer()))
            ,"Fishtail "+(sweepAlignment==autoOptions.SWEEP_EDGE?"Center ":"Edge ") +(startSide==autoOptions.BORDER_LEFT?"Left":"Right"));
    }
