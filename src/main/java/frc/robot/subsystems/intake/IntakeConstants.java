...
public class IntakeConstants {
  ...
  public static final Angle intakeIdleExtensionPosition = Rotations.of(0.21); // TODO: This change is due to not wanting to have a different idle position than fully deployed.
